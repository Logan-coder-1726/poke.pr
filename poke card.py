...
Img=ImageTk.PhotoImage(Image.open ("pikachuf.webp"))
...
def player1():
    ...
    random_poke_label["text"] = "player 1 did  this much damage : " + str(random_no)
...
def player2():
    ...
    random_poke_label["text"] = "player 2 did  this much damage : " + str(random_no2)
